...
def separate_captions(caption, api, llm):
  if llm=='gpt-3.5-turbo':
    openai.api_key=api
    caption_prompt = f"Please separate the given full caption into the exact subcaptionsand format as a dictionary with keys the letter of each subcaption. If the caption is empty return an empty dictionary. Do not hallucinate \n{caption}"
